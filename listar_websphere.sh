...
**Explicación del Script**
  ...
  Bash: Se encarga de extraer los datos del documento y pasarlos a Python.
  Python: Procesa la información para generar una estructura clara y organizada.
...
**¿Cómo ejecutarlo?**
  ...
  1) Guarda el script como listar_websphere.sh.
  2) Otorga permisos de ejecución:
         chmod +x listar_websphere.sh
  3) Ejecútalo:
         ./listar_websphere.sh
  4)Revisa el resultado en resultado_websphere.txt.
